...
class Controller_Backend_Media extends Controller {
	...
	private $mime = array(
		...
		// image
		'jpeg' => array('type' => 'image', 'content_type' => 'image/jpeg'),
	...
	public function action_index()
	{
		try
		{
			...
			$back_tpl_dir = Cms_Helper::settings('back_tpl_dir');

			$full_path = $back_tpl_dir.'/media/'.$staff;
