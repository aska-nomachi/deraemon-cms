...
(8, 'frontend template directory', 'front_tpl_dir', 'contents/frontend/basic'),
...
(18, 'site url', 'site_url', '***site_url***'),
(19, 'site details', 'site_details', 'address: ----------\ntel: ----------\nfax: ----------\nemail: ----------\nurl: ----------'),
(21, 'pagenate items per page for items', 'pagenate_items_per_page_for_items', '10'),
(22, 'pagenate follow for items', 'pagenate_items_follow_for_items', '2'),
(23, 'pagenate items per page for users', 'pagenate_items_per_page_for_users', '10'),
(24, 'pagenate follow for users', 'pagenate_items_follow_for_users', '1'),
(25, 'pagenate items per page for received emails', 'pagenate_items_per_page_for_received_emails', '4'),
(26, 'pagenate items follow for received emails', 'pagenate_items_follow_for_received_emails', '3'),
(27, 'pagenate items per page for received comments', 'pagenate_items_per_page_for_received_comments', '10'),
(28, 'pagenate items follow for received comments', 'pagenate_items_follow_for_received_comments', '1'),
